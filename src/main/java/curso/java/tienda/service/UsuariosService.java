...
public class UsuariosService {
	...
	public Usuarios crearUsuario(int idRol, String email, String clave, String nombre, String apellido1,
			String apellido2, String direccion, String municipio, String provincia, String telefono, String dni) {
		if (!existeUsuarioDni(dni)) {
			Usuarios u = new Usuarios(idRol, email, clave, nombre, apellido1, apellido2, direccion, municipio,
					provincia, telefono, dni);
